          ...
          <div className="flex flex-grow flex-col justify-center">
            ...
            <div className="flex flex-col gap-2">
              <a
                target="_blank"
                rel="noopener noreferrer"
                className={`m-auto inline-flex items-center justify-center rounded-lg py-0 text-center text-base font-semibold text-[#000000]`}
              >
                <span className="text-sm font-[500]"> 1 super AD</span>
              </a>
            </div>
          </div>
          <div>
            <button
              className="mx-auto mt-6 flex w-[70px] justify-center rounded-lg bg-[#00BCFF] py-1 text-sm font-bold text-white shadow-md transition-colors duration-200 hover:bg-[#1e4a70]"
        ...
        <div className="relative flex w-full gap-3 rounded-lg border-1 border-[#e5e7eb] bg-white p-3 shadow-xl">
          ...
          <div className="flex flex-grow flex-col justify-center">
            ...
            <div className="-mt-12 flex flex-col gap-2">
              ...
              >
                <span className="text-sm font-[500]"> 1 NORMAL AD</span>
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-grow flex-col justify-center">
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className={`inline-flex items-center justify-center rounded-lg py-0 text-lg font-semibold text-[#000000]`}
              >
                <span className="text-ce text-sm font-[500]"> 30 ADS PREM</span>
              </a>
            </div>
          </div>
          <div>
